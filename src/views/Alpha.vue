...
export default {
  ...
  // computed: {
  //   payTokenApproved() {
  //     return store.state.approvals.payToken;
  //   },
  // },
  methods: {
    ...mapActions(["disconnect", "reset", "getYamBalance", "updateApprovals", "getMetaPool", "getPrice", "canWithdrawCheck"]),
    async getConnector() {
    ...
    // async payTokenApprovalCheck() {
    //   setTimeout(() => {
    //     this.approvals.payToken = true;
    //   }, 10000);
    // },
